...
$traceurRuntime.ModuleStore.registerModule("traceur@0.0.24/src/codegeneration/module/ModuleRuntimeUtils", function() {
  "use strict";
  var __moduleName = "traceur@0.0.24/src/codegeneration/module/ModuleRuntimeUtils";
  var $__331 = Object.freeze(Object.defineProperties(["System.get(", " +'')"], {raw: {value: Object.freeze(["System.get(", " +'')"])}})),
      $__332 = Object.freeze(Object.defineProperties(["Object.defineProperty(System, 'version',\n        {get: function(){ return ", "}});"], {raw: {value: Object.freeze(["Object.defineProperty(System, 'version',\n        {get: function(){ return ", "}});"])}}));
  var parseStatement = $traceurRuntime.getModuleImpl("traceur@0.0.24/src/codegeneration/PlaceholderParser").parseStatement;
  var ModuleRuntimeUtils = {
    ...
    createSystemVersionStatement: function(referrerName) {
      return parseStatement($__332, referrerName);
    }
  };
  return {get ModuleRuntimeUtils() {
      return ModuleRuntimeUtils;
    }};
});
...
$traceurRuntime.ModuleStore.registerModule("traceur@0.0.24/src/traceur", function() {
  ...
  var ModuleTransformer = $traceurRuntime.getModuleImpl("traceur@0.0.24/src/codegeneration/ModuleTransformer").ModuleTransformer;
  var ParseTreeTransformer = $traceurRuntime.getModuleImpl("traceur@0.0.24/src/codegeneration/ParseTreeTransformer").ParseTreeTransformer;
  var ModuleRuntimeUtils = $traceurRuntime.getModuleImpl("traceur@0.0.24/src/codegeneration/module/ModuleRuntimeUtils").ModuleRuntimeUtils;
  ...
  var codegeneration = {
    ...
    module: {
      ...
      ModuleRuntimeUtils: ModuleRuntimeUtils
    }
  };
  var Loader = $traceurRuntime.getModuleImpl("traceur@0.0.24/src/runtime/Loader").Loader;
  var LoaderHooks = $traceurRuntime.getModuleImpl("traceur@0.0.24/src/runtime/LoaderHooks").LoaderHooks;
...
Object.defineProperty(System, 'version', {get: function() {
    return "traceur@0.0.24";
  }});
